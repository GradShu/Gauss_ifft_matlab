...
%相位,加上色散
a0 = 10000;a1 = -26000;a2 = -1000;
dispersion = a0*sigma.^2+a1*sigma+a2;
phase = -4*pi*z0*sigma+dispersion;
...
figure(4),plot(sigma,dispersion);
...
figure(3);
subplot(2,1,1);plot(z,abs(S_z));xlabel('z(um))','FontSize',12);ylabel('Light Intensity','FontSize',12);xlim([200 400]);
subplot(2,1,2),plot(z,angle(S_z)./pi);xlabel('z(um)','FontSize',12);ylabel('Phase','FontSize',12);xlim([298 302]);

%线性拟合a0+(a1-4*pi*z0)*sigma
